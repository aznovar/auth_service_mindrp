...
func (a *Auth) RegisterNewUser(ctx context.Context, socialId string, email string, pass string) (int64, error) {
	...
	id, err := a.usrSaver.SaveUser(ctx, socialId, email, passHash)
	if err != nil {
